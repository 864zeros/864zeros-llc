...
## 10.5 Panel UI Patterns

Standard UI patterns for side panel extensions. Follow these for consistency across all 864zeros extensions.

### 10.5.1 Settings Access

**Settings are ALWAYS a cog icon in the top-right of the panel header.** Never use a footer button or bottom placement for settings.

```html
<header class="panel-header">
  <h1 class="panel-title">App Name</h1>
  <button class="panel-header__settings" id="open-options" title="Settings" aria-label="Open settings">
