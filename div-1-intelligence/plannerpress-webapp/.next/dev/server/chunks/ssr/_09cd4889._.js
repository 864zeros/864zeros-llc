...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        ...
        if (email === 'test@example.com' && password === 'password') {
            ...
            alert('Invalid credentials or user not found. Try test@example.com / password');
            setLoading(false);
            return false;
        }
    };
...
function AuthGuard({ children }) {
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useRouter"])();
...
//# sourceMappingURL=_09cd4889._.js.map